<template>
  <section id="tables">
                    ...
                    <td class="pt-3-half">
                     ...
                     <td>
                      <span class="table-remove">
                         <button type="button" class="btn btn-danger pa-3"><i class="fas fa-ban" aria-hidden="true"></i></button>
                      </span>
                    </td>
                  </tr>
                </tbody>
    ...
    <SavingAccount v-if="showSavingAccount" @close-modal="showSavingAccount=false" @add-success="reload" />
  </section>
</template>
...
import SavingAccount from "./../Popup/SavingAccount";
export default {
  name: "Tables",
  components: {
    mdbRow,
...
// api/bank/users/{id / me}/recharge-transfers) (data: limit/page
        ...
        axios
          .get(
            "api/bank/users/" + this.id + "/accounts?limit=" +
